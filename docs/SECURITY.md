...
> Note: this is a design document. It describes the intended security model for the full product. The README lists the controls that are currently implemented in this codebase.
