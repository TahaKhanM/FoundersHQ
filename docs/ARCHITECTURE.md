...
> Note: this is a design document. The "current state" section reflects what is built. The "target state" and later sections describe the intended architecture beyond the current codebase.
